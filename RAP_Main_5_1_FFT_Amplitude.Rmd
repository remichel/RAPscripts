...
mcc_ntests          = 20 # number of tests to correct for (Bonferroni)
```

```{r paths, include = FALSE}
study_path          = 'Z:/René/RATES/RAP_OSF/'
preprocessed_path   = paste0(study_path,'Preprocessed/') 
mm_out_path         = paste0(study_path,'MM_Out_Labserver/') 
fft_out_path        = paste0(study_path,'FFT_Out/')  
plot_path           = paste0(study_path,'Plots3/')
...
permplot = ggplot(data = plotdata[plotdata$permNum > 0,], aes(x = amplitude))+
  ...
  geom_vline(xintercept = sig_line$thres, size = 4, color = 'grey10', linetype = 'dashed')+
  geom_vline(xintercept = sig_line$thres_bonf, size = 4, color = 'grey70', linetype = 'dashed')+
  geom_vline(xintercept = sig_line$amplitude, size = 4, color = "sienna2", linetype = "solid")+

...
amp_plot = ggplot(data = thres, aes(x = freq, y = amplitude))+
  ...
  geom_ribbon(data = thres[thres$method == "thres_bonf",], aes(ymin = 0, ymax = thres), fill = "grey80", alpha =.2)+ # ribbon for bonferroni
  geom_ribbon(data = thres[thres$method == 'thres',], aes(ymin = 0, ymax = thres), fill = "grey40" , alpha =.3)+ # ribbon for.95 quantile
  geom_line(size = 12)+
